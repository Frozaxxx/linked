...
class Settings(BaseSettings):
    ...
    yandex_gpt_max_retries: int = 1
    yandex_gpt_rerank_enabled: bool = True
    yandex_gpt_rerank_temperature: float = 0.0
    yandex_gpt_rerank_max_candidates: int = 4
    yandex_gpt_good_message_prompt: str = (
    ...
    yandex_gpt_bad_message_prompt: str = (
        "Ты SEO-аналитик. На основе JSON с результатом анализа внутренней перелинковки сформируй "
    ...
    fetch_partial_crawl_timeout_seconds: float = 3.0
    fetch_partial_min_links_for_crawl: int = 24
    fetch_partial_min_links_for_start_page: int = 80
    fetch_partial_min_links_for_target_branch: int = 48
