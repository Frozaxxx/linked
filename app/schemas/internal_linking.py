...
class LinkingAnalyzeRequest(SeoLinkedModel):
    target_url: AnyHttpUrl = Field(
        ...,
        description="URL С†РµР»РµРІРѕР№ СЃС‚СЂР°РЅРёС†С‹. РџРѕ РЅРµРјСѓ Р°РЅР°Р»РёР·Р°С‚РѕСЂ РЅР°С…РѕРґРёС‚ РіР»Р°РІРЅСѓСЋ СЃС‚СЂР°РЅРёС†Сѓ СЃР°Р№С‚Р° Рё Р·Р°РїСѓСЃРєР°РµС‚ РѕР±С…РѕРґ.",
    )

    model_config = {
        **SeoLinkedModel.model_config,
        "json_schema_extra": {
            "example": {
...
class AnalyzeTimings(SeoLinkedModel):
    total_ms: float
    match_ms: float | None
...
class CrawlDiagnostics(SeoLinkedModel):
    crawl_max_depth: int
...
class FetchStats(SeoLinkedModel):
        ...
        **SeoLinkedModel.model_config,
        "json_schema_extra": {
            "example": {
                ...
                "message": (
                    "Р¦РµР»РµРІР°СЏ СЃС‚СЂР°РЅРёС†Р° РЅР°С…РѕРґРёС‚СЃСЏ РІ 3 С€Р°РіР°С… РѕС‚ СЃС‚Р°СЂС‚РѕРІРѕР№ РїСЂРё РїРѕСЂРѕРіРµ 4, "
                    "РїРѕСЌС‚РѕРјСѓ РїРµСЂРµР»РёРЅРєРѕРІРєР° РІС‹РіР»СЏРґРёС‚ С…РѕСЂРѕС€РµР№."
                ),
                "message_source": "llm",
                "message_error": None,
                "pages_fetched": 7,
